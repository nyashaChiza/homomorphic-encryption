...
class AgeDashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        context['treatment_age_donut_x'] = list(analytics.get_treatments_by_age_group().keys())
        context['treatment_age_donut_y'] = list(analytics.get_treatments_by_age_group().values())
        context['test_age_donut_x'] = list(analytics.get_tests_by_age_group().keys())
        context['test_age_donut_y'] = list(analytics.get_tests_by_age_group().values())
